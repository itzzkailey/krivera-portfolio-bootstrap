...
function displayPlantIDInfo() {
  ...
  reader.onload = function (e) {
    ...
    var language = 'en' 
    var apiUrlPlantID = `https://plant.id/api/v3/identification?details=${details}&language=${language}`;
...
function uploadAndIdentifyPlantID() {
  ...
  reader.onload = function (e) {
    ...
    console.log('base64Image', base64Image);
    // store variables for the API call 
    const apiKey = 'vka05A9TavUdT4CW17GZ1fogh8TP7tVhX8recXWMPoQXolSLxn';
